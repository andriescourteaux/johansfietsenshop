...
Assert-Matches $cssContent '(?is):root\s*\{[^}]*--container\s*:\s*108rem' 'assets/css/style.css wider page canvas'
...
Assert-Matches $cssContent '(?is)\.contact-page__button-icon\b[^{}]*\{[^}]*width\s*:\s*2\.35rem' 'assets/css/style.css larger contact icons'
