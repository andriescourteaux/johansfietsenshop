...
Assert-Matches $cssContent '(?is)@media\s*\(max-width:\s*720px\)\s*\{[^@]*\.container\b[^{}]*\{[^}]*width\s*:\s*min\(calc\(100%\s*-\s*1rem\),\s*var\(--container\)\)' 'assets/css/style.css mobile container gutters'
